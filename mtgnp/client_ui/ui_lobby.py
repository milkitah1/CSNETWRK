...
class LobbyCardSelectionState:
    ...
    def create_windows(self):
        ...
        selection_window_height = 8

        old_selected = self.selection_window.selected_cards if self.selection_window else []
        ...
        self.selection_window = SelectionWindow(selection_window_height, window_width1, start_y2, start_x3)
        self.selection_window.selected_cards = old_selected
